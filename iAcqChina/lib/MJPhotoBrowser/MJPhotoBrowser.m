...
@interface MJPhotoBrowser () <MJPhotoViewDelegate,ToolbarDelegate>
{
    // 滚动的view
...
- (void)setPhotos:(NSArray *)photos
{
    ...
    for (int i = 0; i<_photos.count; i++) {
        ...
        photo.index = i;
        //peter photo.firstShow = i == _currentPhotoIndex;
    }
}
...
- (void)setCurrentPhotoIndex:(NSUInteger)currentPhotoIndex
{
    ...
    for (int i = 0; i<_photos.count; i++) {
        MJPhoto *photo = _photos[i];
        // peter photo.firstShow = i == currentPhotoIndex;
    }
