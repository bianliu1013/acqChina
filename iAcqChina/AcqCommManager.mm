...
- (void) RecvProcBlock
{
    if (_isConnected) {
        ...
        [asyncSocket readDataToLength:10
                          withTimeout:10000.0
                                  tag:0];
    }
...
-(BOOL)SendMessage:(NSData*) data withLen:(NSInteger)len
{
    ...
    NSString *requestStr2 = @"peter\n";
    NSData *requestData2 = [requestStr2 dataUsingEncoding:NSUTF8StringEncoding];
    [asyncSocket writeData:requestData2 withTimeout:-1.0 tag:0];
...
- (void)socket:(GCDAsyncSocket *)sock didReadData:(NSData *)data withTag:(long)tag
{
    ...
    [_delegate OnTriggerCaptureCmd:urlString];
